...
if ! type -q git-filter-repo
    proxy-wget2 -NP /tmp 'https://launchpad.net/ubuntu/+archive/primary/+files/git-filter-repo_2.29.0-1_all.deb'
    sudo apt install /tmp/git-filter-repo_2.29.0-1_all.deb
end

proxy-wget2 -NP /tmp 'https://download.calibre-ebook.com/linux-installer.sh'
